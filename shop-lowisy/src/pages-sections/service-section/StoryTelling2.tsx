...
const storytelling2 = `assets/images/headers/storytelling2.jpg`;
          ...
          <Grid item xs={12} md={6} sx={{ p: 0 }}>
            ...
            >
              <Image
                ...
                sx={{
                  width: "100%",
                  height: { lg: "650px", md: "550px", sm: "400px" },
                }}
              />
            </Box>
          </Grid>
