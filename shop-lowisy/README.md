...
Lowisy react follows [Next.js routing standard](https://nextjs.org/docs/routing/introduction).
...
Need Support? Create a ticket [HERE](https://support.lowisy.com/help-center/tickets/new) Or Send us an email at [info@lowisy.com](mailto:info@lowisy.com).
